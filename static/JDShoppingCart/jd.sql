...
insert into jd_user values(null,'qiangdong','123456','lqd@qq.com',null,50,1234567891112);
...
create table if not exists jd_cart(cid int primary key auto_increment,userId int);
insert into jd_cart values(100,1);
create table if not exists jd_cart_detail(did int primary key auto_increment,cartId int,productId int,count int);
insert into jd_cart_detail values(1,100,10,3),(2,100,15,1),(3,100,18,2);
...
insert into jd_lottery values(null,1,123456789,1),(null,1,123456789,1),(null,1,123456789,1);
